...
>>>>>>> 1aa6b1a664da6939d49d13d6f4aa1c278fe9b0ca
}
      ...
      <main>
        <section className="intro">
          <div>
            ...
            <h1>Turn the call into a clear response picture.</h1>
            <p>
              Extract what is known, surface what is missing, and compare the
              teams equipped to help.
            </p>
          </div>
        ...
        <section className="panel teams-panel">
          <div className="panel-head">
            <div>
              ...
              <h2>Suitable teams</h2>
            </div>
            <span className="muted">
              Ranked by capability, availability & ETA
            </span>
          </div>
          {!rankedTeams.length ? (
            <Empty
            ...
            <div className="team-grid">
              {rankedTeams.map((team, index) => {
                const score =
                  typeof team.score === "number" ? team.score : rankTeam(team);
                const reasons =
                  team.reasons ??
                  (team.capabilities || [])
                    .slice(0, 3)
                ...
                return (
                  <article
                    className={`team ${index === 0 ? "recommended" : ""}`}
                    key={team.id}
                  >
                    ...
                    {index === 0 && (
                      <span className="ribbon">BEST CURRENT FIT</span>
                    )}
                    <div className="team-status">
                      ...
                      <strong>
                        {team.etaMinutes} min <small>estimated</small>
                      </strong>
                    </div>
                    ...
                    >
                      {selected === team.id
                        ? "Selected for dispatcher review ✓"
                        : "Select for review"}
                    </button>
                  </article>
                );
