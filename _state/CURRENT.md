...
The incident picture panel now shows the current facts in the top half and a generated METHANE dispatch message in the bottom half. The message updates from the selected rescue team so the dispatcher can send it without retyping.
